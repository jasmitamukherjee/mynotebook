...
const AddNote = () => {
  ...
  <button disabled={note.title.length<5 || note.description.length<5} type="submit" className="btn btn-dark btn-outline-light" onClick={handleClick}>Add Note</button>
</form>
</div>
    </div>
  )
